  ...
  (self["webpackChunkmyApp"] = self["webpackChunkmyApp"] || []).push([["src_app_scan-qr_qr-scan_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _QrScan = /*#__PURE__*/function () {
        function QrScan(qrScanner, http, httpRequest, camera) {
          ...
          this.showTakePic = false; // private basicUrl = 'https://be-app-hiring-bixinf-test.apps.bi-x-ire.tftp.p1.openshiftapps.com/'
        ...
        _createClass(QrScan, [{
          ...
          value: function ngOnInit() {
            console.log('on init');
            this.httpRequest.get('api/v1.0/status', {}, function (res) {
              console.log(res);
            });
          }
        }, {
              ...
              if (status.authorized) {
                ...
                var scanSub = _this.qrScanner.scan().subscribe(function (text) {
                  if (text && typeof text.result === 'string') {
                    ...
                    _this.basicUrl = tempArr[0];
                    _this.username = tempArr[1].split(':')[1];
                    _this.password = tempArr[2].split(':')[1];

                    _this.httpRequest.get('api/v1.0/status', {}, function (res) {
          ...
          value: function takePic() {
            ...
            this.camera.getPicture(options).then(function (imageData) {
              ...
              _this3.http.post(url, param, httpOptions).subscribe(function (res) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _httpRequest = /*#__PURE__*/function () {
        ...
        _createClass(httpRequest, [{
          ...
          key: "post",
          value: function post(url, data, callback, options) {
            var vm = this;
