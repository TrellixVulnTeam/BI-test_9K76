...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "QrScanRoutingModule": function() { return /* binding */ QrScanRoutingModule; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ 37716);
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ 39895);
/* harmony import */ var _qr_scan__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./qr-scan */ 90287);
...
let QrScanRoutingModule = class QrScanRoutingModule {
};
QrScanRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
/* harmony import */ var _qr_scan__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./qr-scan */ 90287);
/* harmony import */ var _qr_scan_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./qr-scan-routing.module */ 35982);
...
HomePageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        imports: [
            ...
            _qr_scan_routing_module__WEBPACK_IMPORTED_MODULE_1__.QrScanRoutingModule
        ],
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "QrScan": function() { return /* binding */ QrScan; }
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! tslib */ 64762);
/* harmony import */ var _raw_loader_qr_scan_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !raw-loader!./qr-scan.html */ 36271);
/* harmony import */ var _qr_scan_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./qr-scan.scss */ 63525);
...
/* harmony import */ var _service_http__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../service/http */ 11356);
...
let QrScan = class QrScan {
    constructor(qrScanner, http, httpRequest, camera) {
    ...
    ngOnInit() {
        console.log('on init');
        this.httpRequest.get('api/v1.0/status', {}, (res) => {
            console.log(res);
        });
    }
    scan() {
    ...
    checkStatus() {
        this.httpRequest.get(`${this.basicUrl}api/v1.0/status`, (res) => {
            this.showScanBtn = false; // switch show btn
            this.status = res.status;
            if (res.status === 'ok') {
                this.showTakePic = true;
    ...
    takePic() {
        ...
        this.camera.getPicture(options).then((imageData) => {
            ...
            this.http.post(url, param, httpOptions).subscribe((res) => {
...
QrScan = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
...
httpRequest.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__.HttpClient }
];
httpRequest = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
