...
let HomePage = class HomePage {
    constructor(qrScanner, http, camera) {
        this.qrScanner = qrScanner;
        this.http = http;
        this.camera = camera;
        this.showScanBtn = true;
        this.showTakePic = false;
        this.basicUrl = 'https://be-app-hiring-bixinf-test.apps.bi-x-ire.tftp.p1.openshiftapps.com/';
        this.status = '';
...
HomePage = (0,tslib__WEBPACK_IMPORTED_MODULE_5__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        ...
        providers: [_ionic_native_qr_scanner_ngx__WEBPACK_IMPORTED_MODULE_2__.QRScanner, _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_3__.Camera],
